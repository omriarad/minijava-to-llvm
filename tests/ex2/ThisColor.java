...
class Color {
    ...
    boolean initColorArray(int[] newRGB){
        rgb = new int[3];
        rgb[0] =  newRGB[0];
        rgb[1] =  newRGB[1];
        rgb[2] =  newRGB[2];
    ...
    boolean initColorInt(int r, int g, int b){
        rgb = new int[3];
        rgb[0] = r;
        rgb[1] = g;
        rgb[2] = b;
    ...
    Color addOut(Color otherColor){
        Color result;
        result = otherColor.addIn(this);
        return otherColor;
    }

    Color switchTo(Color otherColor){
        otherColor = this;
        return otherColor;
    }
